...
test('debug OTP con código fijo del mock', async ({ page }) => {
  console.log('🐛 Debug OTP con código fijo...');
  ...
  console.log('Pantalla OTP visible, usando código fijo 123456...');
  
  // Usar el código fijo del mock
  ...
  try {
    ...
    await page.screenshot({ path: 'debug-fixed-otp-failed.png', fullPage: true });
