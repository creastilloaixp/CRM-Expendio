...
const AIAssistant: React.FC<AIAssistantProps> = ({ visits, systemPrompt, suggestions }) => {
  ...
  const suggestionChips = suggestions ?? [
    ...
    "¿Quiénes son nuestros clientes más frecuentes?",
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await getInsights(visits, input, systemPrompt);
